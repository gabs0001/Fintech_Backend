...
public class InstituicaoController {
    ...
    @GetMapping
    public ResponseEntity<List<Instituicao>> buscarTodos() throws SQLException {
        List<Instituicao> todasAsInstituicoes = instituicaoService.getAll();
        return ResponseEntity.ok(todasAsInstituicoes);
    }

    @GetMapping("{id}")
    public ResponseEntity<Instituicao> buscarPorId(@PathVariable Long id) throws SQLException {
    ...
    @PostMapping
    public ResponseEntity<Instituicao> salvar(@RequestBody Instituicao instituicao) throws SQLException, EntityNotFoundException {
    ...
    @PutMapping("{id}")
    public ResponseEntity<Instituicao> atualizar(@PathVariable("id") Long id, @RequestBody Instituicao instituicao) throws SQLException, EntityNotFoundException {
